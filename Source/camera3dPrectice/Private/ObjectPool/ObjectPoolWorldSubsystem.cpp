...
#include "ObjectPool/ObjectPoolWorldSubsystem.h"

#include "ObjectPool/PooledObjectComponent.h"

UObjectPoolWorldSubsystem::UObjectPoolWorldSubsystem()
{
    FString RefText = FString::Printf(TEXT("/Script/camera3dPrectice.ObjectPoolDataAsset'/Game/MyTestDataAsset/DA_ObjectPoolAsset.DA_ObjectPoolAsset'"));
